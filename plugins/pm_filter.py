...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("✘ Movie Updates ", url="https://telegram.dog/BollyWeeBHolly"),
                InlineKeyboardButton("BollyWeBHolly Adult 🔞", url="https://telegram.dog/BollyWeBHollyAdult")
            ])

    btn.insert(0, [
        InlineKeyboardButton("Hσω тσ Dσωηℓσα∂ 🤔", url="https://telegram.dog/Bolly4u_4k")
            ]
        )
    try:
